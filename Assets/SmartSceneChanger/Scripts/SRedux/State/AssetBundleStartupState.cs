namespace SSC
{
    ...
    /// <summary>
    /// AssetBundleStartupState class
    /// </summary>
    public class AssetBundleStartupState
    {
        ...
        public void setState(StateWatcher<AssetBundleStartupState> watcher, StateEnum _stateEnum, string _error, string _url)
        {
