...
namespace SSC
{
    ...
    /// <summary>
    /// Simple progress dialog UI controller
    /// </summary>
    [RequireComponent(typeof(RectTransform))]
    [RequireComponent(typeof(CanvasGroup))]
    public class SimpleProgressDialogUiControllerScript : ProgressDialogUiControllerScript
    {
